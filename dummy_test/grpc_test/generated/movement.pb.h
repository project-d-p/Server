...
class Movement final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Movement) */ {
 public:
  inline Movement() : Movement(nullptr) {}
  ~Movement() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Movement(::google::protobuf::internal::ConstantInitialized);

  inline Movement(const Movement& from)
      : Movement(nullptr, from) {}
