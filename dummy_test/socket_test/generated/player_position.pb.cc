...
const ::uint32_t TableStruct_player_5fposition_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_player_5fposition_2eproto(&descriptor_table_player_5fposition_2eproto);
// ===================================================================
...
const ::Vec3& PlayerPosition::_Internal::position(const PlayerPosition* msg) {
  return *msg->_impl_.position_;
}
const ::Vec3& PlayerPosition::_Internal::orientation(const PlayerPosition* msg) {
...
PlayerPosition::PlayerPosition(
  ...
  _impl_.position_ = (cached_has_bits & 0x00000001u)
                ? CreateMaybeMessage<::Vec3>(arena, *from._impl_.position_)
                : nullptr;
