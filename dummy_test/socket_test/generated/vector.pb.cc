...
const ::uint32_t TableStruct_vector_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_vector_2eproto(&descriptor_table_vector_2eproto);
// ===================================================================
